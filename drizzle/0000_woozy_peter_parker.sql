CREATE TYPE "public"."role" AS ENUM('SUPER_ADMIN', 'ADMIN', 'TEACHER', 'STUDENT', 'PARENT', 'ACCOUNTANT');--> statement-breakpoint
...
ALTER TABLE "teacher_school_history" ADD CONSTRAINT "teacher_school_history_school_id_schools_id_fk" FOREIGN KEY ("school_id") REFERENCES "public"."schools"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
